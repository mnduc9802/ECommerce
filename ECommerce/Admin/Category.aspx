        ...
        <div class="col-sm-12 col-md-4">
            <div class="card">
                <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <asp:RequiredFieldValidator ID="rfvCategoryName" runat="server" ForeColor="Red" Font-Size="Small" Display="Dynamic"
                                        SetFocusOnError="true" ControlToValidate="txtCategoryName" ErrorMessage="Category Name is required"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                        </div>
                    ...
                    <div>
                        <asp:Image ID="imagePreview" runat="server" CssClas="img-thumbnail" AlternateText="" />
                    </div>
